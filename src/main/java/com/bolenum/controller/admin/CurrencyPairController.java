...
//	
//	@Secured("ROLE_USER")
//	@RequestMapping(value = UrlConstant.ALL_CURRENCY_PAIR_LIST, method = RequestMethod.GET)
//	public ResponseEntity<Object> getAllCurrencyPairList() {
//		List<CurrencyPair> currencyPairList = currencyPairService.getALLCurrencyList();
//		if (currencyPairList != null) {
//			return ResponseHandler.response(HttpStatus.OK, false,
//					localeService.getMessage("currency.pair.list.success"), currencyPairList);
//		}
