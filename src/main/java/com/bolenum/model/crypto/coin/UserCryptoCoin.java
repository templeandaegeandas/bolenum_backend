package com.bolenum.model.crypto.coin;
...
public class UserCryptoCoin {
	...
	public UserCryptoCoin(String walletAddress, Double balance, String tokenName, String walletJsonFile,
	...
	/**
	 * @param walletJsonFile the walletJsonFile to set
	 */
	...
	/**
	 * @param walletPwdKey the walletPwdKey to set
	 */
