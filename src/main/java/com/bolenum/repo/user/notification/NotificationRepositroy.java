...
public interface NotificationRepositroy extends JpaRepository<Notification, Serializable> {
	...
	@Query("select n from Notification n where (n.receiver = :user and n.createdOn <= :endDate and n.createdOn >= :startDate and n.readStatus = :readStatus) or (n.receiver = :user and n.readStatus = :readStatus)")
